...
This File Integrity Checker automates the process of validating file integrity within a target directory. It functions by calculating the SHA256 checksum of files and storing them in a persistent SQLite3 database.
